      ...
      <div className="mx-auto w-full max-w-7xl px-6 py-16 sm:px-8 md:px-12 lg:px-16 lg:py-24">
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-8">
          ...
          <button
            ...
            className="text-gray-300 hover:text-orange-400 transition-colors font-light text-left"
          >
            Back to top ↑
          </button>
        </div>
        <p className="copyright-line mt-8 text-[12px] leading-snug text-gray-500">© 2026 SPRDLX. All rights reserved.</p>
      </div>
    </footer>
  );
}
