...
function Contact() {
  ...
  return (
    <div className="contact-container relative w-full min-h-screen bg-black text-white font-sans flex flex-col items-center justify-center py-16 sm:py-24 md:py-32">
      ...
      {/* Logo */}
      <div className="absolute top-6 left-6 z-20 w-12 h-12 sm:w-14 sm:h-14">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-2xl px-4 sm:px-6 w-full">
        <TextGenerateEffect
          words="Get In Touch"
          className="text-xs sm:text-sm md:text-base font-light uppercase tracking-widest text-white/60 mb-4 sm:mb-6"
          duration={0.5}
          staggerDelay={0.1}
          filter={false}
          delay={3}
